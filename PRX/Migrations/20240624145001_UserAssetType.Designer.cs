...
namespace PRX.Migrations
{
    ...
    [Migration("20240624145001_UserAssetType")]
    partial class UserAssetType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PRX.Models.User.UserAssetType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            Name = " اوراق مشارکت دولتی و شرکتی"
                        },
                        new
                        {
                            Id = 6,
                            Name = "وجه نقد/ مطالبات از سایز افراد/ حساب پس انداز و سپرده بانکی"
                        },
                        new
                        {
                            Id = 7,
