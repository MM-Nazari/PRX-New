    ...
    public class ReportController : ControllerBase
    {
        ...
        public async Task<IActionResult> Export()
        {
            ...
            using (var package = new ExcelPackage(memoryStream))
            {
                ...
                var userFinancialChangesSheet = package.Workbook.Worksheets.Add("UserFinancialChanges");
                ...
                var userDocumentSheet = package.Workbook.Worksheets.Add("UserDocuments");
                ...
                var userDepositSheet = package.Workbook.Worksheets.Add("UserDeposits");
                ...
                var userAssetSheet = package.Workbook.Worksheets.Add("UserAssets");
                ...
                var userFuturePlansSheet = package.Workbook.Worksheets.Add("UserFuturePlans");
                ...
                var userInvestmentSheet = package.Workbook.Worksheets.Add("UserInvestments");
                ...
                var userInvestmentExperienceSheet = package.Workbook.Worksheets.Add("UserInvestmentExperiences");
                ...
                var userMoreInformationSheet = package.Workbook.Worksheets.Add("UserMoreInformation");
                ...
                var userWithdrawalSheet = package.Workbook.Worksheets.Add("UserWithdrawals");
                ...
                var userTestScoreSheet = package.Workbook.Worksheets.Add("UserTestScores");
                ...
                var haghighiUserBankInfoSheet = package.Workbook.Worksheets.Add("HaghighiUserBankInfos");
                ...
                var haghighiUserEducationStatusSheet = package.Workbook.Worksheets.Add("HaghighiUserEducationStatuses");
                ...
                var haghighiUserFinancialProfileSheet = package.Workbook.Worksheets.Add("HaghighiUserFinancialProfiles");
                ...
                var haghighiUserRelationshipsSheet = package.Workbook.Worksheets.Add("HaghighiUserRelationships");
                ...
                var haghighiUserProfileSheet = package.Workbook.Worksheets.Add("HaghighiUserProfiles");
                ...
                var haghighiUserEmploymentHistorySheet = package.Workbook.Worksheets.Add("HaghighiUserEmploymentHistories");
                ...
                var hoghooghiUserInvestmentDepartmentStaffSheet = package.Workbook.Worksheets.Add("HoghooghiUserInvestmentDepartmentStaff");
                ...
                var hoghooghiUserCompaniesWithMajorInvestorsSheet = package.Workbook.Worksheets.Add("HoghooghiUserCompaniesWithMajorInvestors");
                ...
                var hoghooghiUserBoardOfDirectorsSheet = package.Workbook.Worksheets.Add("HoghooghiUserBoardOfDirectors");
                ...
                var hoghooghiUserAssetIncomeStatusTwoYearsAgoSheet = package.Workbook.Worksheets.Add("HoghooghiUserAssetIncomeStatusTwoYearsAgo");
                ...
                var hoghooghiUserSheet = package.Workbook.Worksheets.Add("HoghooghiUsers");
